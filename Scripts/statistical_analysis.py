...
def differentially_expressed_peaks(gff_folder, condition_compare_file, csv_folder, z_min, z_max, agree_distance, differentially_expressed_genes_All_folder, differentially_expressed_genes_HighConfidence_folder, DEG_HIGH_Dens_folder, density_cutoff, DEG_Overlap_folder, DEG_Overlap_lessStringent_folder):

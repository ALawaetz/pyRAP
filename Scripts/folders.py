...
GFF3_folder_3 = os.getcwd() + '/Pipeline/Annotation_files/'
...
if 'FDR_tuples' not in os.listdir(pipeline_folder):
    os.mkdir(os.getcwd() + '/Pipeline/FDR_tuples')
FDR_tuples_folder = os.getcwd() + '/Pipeline/FDR_tuples/'
